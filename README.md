...
<div> <h3>Web Development Skills</h3> </div>
 ...
 [![Web Stack](https://skillicons.dev/icons?i=html,css,tailwind,bootstrap,sass,figma,javascript,ts,react,redux,nextjs,nodejs,expressjs,mongodb,mysql,firebase,git,github&perline=11)](https://skillicons.dev)
